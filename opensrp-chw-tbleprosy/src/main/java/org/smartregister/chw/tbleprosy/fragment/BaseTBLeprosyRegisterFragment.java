...
public class BaseTBLeprosyRegisterFragment extends BaseRegisterFragment implements TBLeprosyRegisterFragmentContract.View {
    public static final String CLICK_VIEW_NORMAL = "click_view_normal";
    public static final String FOLLOW_UP_VISIT = "follow_up_visit";

    @Override
    public void initializeAdapter(Set<View> visibleColumns) {
        TBLeprosyRegisterProvider TBLeprosyRegisterProvider = new TBLeprosyRegisterProvider(getActivity(), paginationViewHandler, registerActionHandler, visibleColumns);
    ...
    @Override
    public TBLeprosyRegisterFragmentContract.Presenter presenter() {
        return (TBLeprosyRegisterFragmentContract.Presenter) presenter;
    }
    ...
    protected void initializePresenter() {
        ...
        presenter = new BaseTBLeprosyRegisterFragmentPresenter(this, new BaseTBLeprosyRegisterFragmentModel(), null);
    }
...
//        start forms here if the module requires registration
    ...
    protected void openProfile(String baseEntityId) {
        BaseTBLeprosyProfileActivity.startProfileActivity(getActivity(), baseEntityId);
    }
