...
public class SkeletonMemberProfileActivity extends BaseSkeletonProfileActivity {
    private Visit enrollmentVisit = null;
    private Visit serviceVisit = null;

    public static void startMe(Activity activity, String baseEntityID) {
        Intent intent = new Intent(activity, SkeletonMemberProfileActivity.class);
...
//    }
    ...
    public void startServiceForm() {
        SkeletonServiceActivity.startSkeletonVisitActivity(this, memberObject.getBaseEntityId(), false);
    }
