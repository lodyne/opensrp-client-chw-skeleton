...
import org.smartregister.chw.skeleton.interactor.BaseSkeletonRegisterInteractor;
import org.smartregister.chw.skeleton.listener.SkeletonBottomNavigationListener;
...
public class BaseSkeletonRegisterActivity extends BaseRegisterActivity implements SkeletonRegisterContract.View {
    ...
    public void startFormActivity(String formName, String entityId, String metaData) {
        try {
            if (mBaseFragment instanceof BaseSkeletonRegisterFragment) {
    ...
    public void startFormActivity(JSONObject jsonForm) {
        Intent intent = new Intent(this, BaseSkeletonRegisterActivity.class);
    ...
    protected void registerBottomNavigation() {
        ...
        if (bottomNavigationView != null) {
            ...
            BottomNavigationListener familyBottomNavigationListener = new SkeletonBottomNavigationListener(this);
    ...
    protected void initializePresenter() {
        presenter = new BaseSkeletonRegisterPresenter(this, new BaseSkeletonRegisterModel(), new BaseSkeletonRegisterInteractor());
    }

    @Override
    protected BaseRegisterFragment getRegisterFragment() {
        return new BaseSkeletonRegisterFragment();
    }
    ...
    @Override
    public SkeletonRegisterContract.Presenter presenter() {
        return (SkeletonRegisterContract.Presenter) presenter;
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == Activity.RESULT_OK && requestCode == Constants.REQUEST_CODE_GET_JSON) {
            ...
            try {
                ...
                JSONArray fieldsOne = SkeletonJsonFormUtils.fields(form, Constants.STEP_ONE);
    ...
    public void startClientProcessing() {
        try {
            ...
            SkeletonUtil.getClientProcessorForJava().processClient(SkeletonUtil.getSyncHelper().getEvents(lastSyncDate, BaseRepository.TYPE_Unprocessed));
