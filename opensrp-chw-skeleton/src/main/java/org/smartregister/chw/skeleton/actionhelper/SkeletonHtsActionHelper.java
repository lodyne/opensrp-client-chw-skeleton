...
public class SkeletonHtsActionHelper implements BaseSkeletonVisitAction.SkeletonVisitActionHelper {
    ...
    public SkeletonHtsActionHelper(Context context, MemberObject memberObject) {
    ...
    public String getPreProcessed() {
        try {
            ...
            String is_client_diagnosed_with_any = SkeletonMedicalHistoryActionHelper.is_client_diagnosed_with_any;
            String any_complaints = SkeletonMedicalHistoryActionHelper.any_complaints;
            String known_allergies = SkeletonMedicalHistoryActionHelper.known_allergies;
            String any_hematological_disease_symptoms = SkeletonMedicalHistoryActionHelper.any_hematological_disease_symptoms;
            String complications_previous_surgical = SkeletonMedicalHistoryActionHelper.complications_previous_surgical;
            String type_of_blood_for_glucose_test = SkeletonMedicalHistoryActionHelper.type_of_blood_for_glucose_test;
            String blood_for_glucose = SkeletonMedicalHistoryActionHelper.blood_for_glucose;
            String blood_for_glucose_test = SkeletonMedicalHistoryActionHelper.blood_for_glucose_test;
            String diagonised_others = SkeletonMedicalHistoryActionHelper.client_diagnosed_other;
            String genital_examination = SkeletonPhysicalExamActionHelper.genital_examination;
            String diastolic = SkeletonPhysicalExamActionHelper.diastolic;
            String systolic = SkeletonPhysicalExamActionHelper.systolic;
