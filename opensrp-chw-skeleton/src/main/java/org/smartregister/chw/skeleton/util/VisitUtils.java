...
public class VisitUtils {
    ...
    public static List<Visit> getVisitsOnly(String memberID, String visitName) {
        return new ArrayList<>(SkeletonLibrary.getInstance().visitRepository().getVisits(memberID, visitName));
    }

    public static List<VisitDetail> getVisitDetailsOnly(String visitID) {
        return SkeletonLibrary.getInstance().visitDetailsRepository().getVisits(visitID);
    }
    ...
    public static void processVisits(String baseEntityID) throws Exception {
        processVisits(SkeletonLibrary.getInstance().visitRepository(), SkeletonLibrary.getInstance().visitDetailsRepository(), baseEntityID);
    }
