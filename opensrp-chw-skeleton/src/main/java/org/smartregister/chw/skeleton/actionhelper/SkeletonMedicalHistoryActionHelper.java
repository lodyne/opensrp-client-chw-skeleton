...
public class SkeletonMedicalHistoryActionHelper implements BaseSkeletonVisitAction.SkeletonVisitActionHelper {
    ...
    public SkeletonMedicalHistoryActionHelper(Context context, MemberObject memberObject) {
