...
import org.smartregister.chw.skeleton.fragment.BaseSkeletonVisitFragment;
 ...
 */
public class BaseSkeletonVisitAction {
    ...
    private BaseSkeletonVisitFragment destinationFragment;
    ...
    private BaseSkeletonVisitAction(Builder builder) throws ValidationException {
        ...
        try {
            if (StringUtils.isBlank(jsonPayload) && StringUtils.isNotBlank(formName)) {
                ...
                if (details != null && details.size() > 0) {
                    SkeletonJsonFormUtils.populateForm(jsonObject, details);
                }
    ...
    public BaseSkeletonVisitFragment getDestinationFragment() {
        return destinationFragment;
    }

    public void setDestinationFragment(BaseSkeletonVisitFragment destinationFragment) {
    ...
    public interface SkeletonVisitActionHelper {
         ...
         */
        void onPayloadReceived(BaseSkeletonVisitAction skeletonVisitAction);
    }
    ...
    public static class Builder {
        ...
        public Builder withDestinationFragment(BaseSkeletonVisitFragment destinationFragment) {
            this.destinationFragment = destinationFragment;
            return this;
        }
        ...
        public BaseSkeletonVisitAction build() throws ValidationException {
            return new BaseSkeletonVisitAction(this);
        }
    }
