...
public class BaseSkeletonRegisterProviderTest {
    @Mock
    public CommonPersonObjectClient commonPersonObjectClient;
    @Mock
    public View.OnClickListener listener;
    @Mock
    public SkeletonRegisterProvider.RegisterViewHolder viewHolder;
    @Mock
    private SkeletonRegisterProvider testRegisterProvider;
    ...
    public void isAncClosed() throws Exception {
        ...
        SkeletonRegisterProvider provider = Mockito.spy(new SkeletonRegisterProvider(activity, listener, listener, null));
    ...
    public void updateMemberGender() throws Exception {
        Activity activity = Mockito.mock(Activity.class);
        Resources resources = Mockito.mock(Resources.class);
        SkeletonRegisterProvider provider = new SkeletonRegisterProvider(activity, listener, listener, null);
        Map<String, String> map = new HashMap<>();
